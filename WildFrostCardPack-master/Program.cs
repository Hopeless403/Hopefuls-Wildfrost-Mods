...
*/
            /* Jolito card example
            CardAdder.CreateCardData("MiyasCardPack", "jolito")
            .SetStats(6,2,5)
            .SetIsUnit()
            .SetStartWithEffects("MiyasCardPack.JolitoEffect".StatusEffectStack(2))
            .SetSprites(CardAdder.LoadSpriteFromCardPortraits("MiyasCardPack\\Jolito"),CardAdder
            .LoadSpriteFromCardPortraits("MiyasCardPack\\TootieBackground"))
            .RegisterCardInApi();
            */
            AddTaintedCards();
        };
