/// Credit to https://github.com/xupefei/APNG.NET
using System;
    ...
    public class APNG
    {
        ...
        public APNG(byte[] fileBytes)
        {
            ...
            if (IHDRChunk.ChunkType != "IHDR")
                throw new Exception("IHDR chunk must be located before any other chunks.");
            ...
            do
            {
                ...
                switch (chunk.ChunkType)
                {
                    ...
                    case "acTL":
                        if (IsSimplePNG)
                            throw new Exception("acTL chunk must be located before any IDAT and fdAT");
