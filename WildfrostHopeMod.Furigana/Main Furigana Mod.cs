...
namespace WildfrostHopeMod.Furigana
{
    public class FuriganaMod : WildfrostMod
    {
        public static Paths Paths;
        public static FuriganaMod Mod;
        public FuriganaMod(string modDirectory) : base(modDirectory)
        {
            Mod = this; Paths = new Paths(ModDirectory);
        }
        public override string GUID => "hope.wildfrost.furigana";
        public override string[] Depends => new string[] { };
        public override string Title => "Furigana for Japanese";
        ...
        public override void Load()
        {
            ...
            var locale = new LocaleIdentifier("uwu");
            LocalizationSettings.SelectedLocale = LocalizationSettings.AvailableLocales.Locales.First(l => l.Identifier == new LocaleIdentifier(SystemLanguage.Japanese));
