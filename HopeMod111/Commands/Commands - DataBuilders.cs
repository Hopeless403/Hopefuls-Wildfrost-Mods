                            ...
                            if (source.Any())
                            {
                                ...
                                switch (dataType.Name)
                                {
                                    case nameof(CardData):
                                        result = new CardDataHandler().Info(file as CardData)[1..];
                                        Debug.LogWarning("\n"+result);
                                        break;
                                    case nameof(StatusEffectData):
                                        result = new StatusEffectDataHandler().Info(file as StatusEffectData)[1..]; 
                                        Debug.LogWarning("\n" + result);
                                        break;
                                    ...
                                    default:
                                        result = new GenericDataHandler().Info(file)[1..];
                                        Debug.LogWarning("\n"+result);
                                        break;
                                }
