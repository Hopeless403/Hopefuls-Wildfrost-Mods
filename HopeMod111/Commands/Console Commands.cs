...
namespace WildfrostHopeMod.CommandsConsole
{
    public partial class ConsoleCustom
    {
        ...
        public static void RegisterCommands()
        {
            ...
            //Console.commands.RemoveAllWhere(c => c.id == "progress gain")
        }
        ...
        public class CommandBattleReset : Console.Command
        {
            ...
            static (IEnumerator coroutine, CampaignNode node) recent;

            [HarmonyPostfix]
            [HarmonyPatch(typeof(Campaign), nameof(Campaign.EnterNode))]
            static void Postfix(IEnumerator __result, CampaignNode node) => recent = (__result, node);
            ...
            public override IEnumerator Routine(string args)
            {
                if (Battle.instance != null)
                {
                    ...
                    {
                        Battle.instance.canEnd = false;
                        yield return Transition.WaitUntilDone(Transition.Begin());
                        bool wasCleared = playerNode.cleared;
                        
                        if (recent != default && recent.node != null && recent.node == playerNode)
                            Campaign.instance.StopCoroutine(recent.coroutine);
                        ...
                        SaveSystem.SaveCampaignData<BattleSaveData>(Campaign.Data.GameMode, "battleState", null);
                    }
        ...
        {
            public override string id => "save backup restore";
            public override bool IsRoutine => false;
