...
public class CardFramesSystem : GameSystem
{
  ...
  private static bool CheckTrueWin() => SaveSystem.LoadCampaignData<bool>(Campaign.Data.GameMode, "trueWin", false);
  ...
  private string[] GetNewCards(int level) => this.newFrameLevels.Where<KeyValuePair<string, int>>((Func<KeyValuePair<string, int>, bool>) (a => a.Value == level)).Select<KeyValuePair<string, int>, string>((Func<KeyValuePair<string, int>, string>) (a => a.Key)).ToArray<string>();
}
