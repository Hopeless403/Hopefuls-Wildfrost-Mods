...
public class RedrawBellSystem : GameSystem
{
  ...
  private RectTransform rectTransform => this._rectTransform ?? (this._rectTransform = (RectTransform) this.transform);

  private UnityEngine.Animator animator => this._animator ?? (this._animator = this.GetComponent<UnityEngine.Animator>());
