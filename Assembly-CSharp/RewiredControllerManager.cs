...
public class RewiredControllerManager : MonoBehaviour
{
  ...
  private static readonly List<RewiredControllerManager.PlayerMap> playerMaps = new List<RewiredControllerManager.PlayerMap>();
  private static int gamePlayerIdCounter = 0;
  private static Player leadPlayer;
  private const int maxJoysticksPerPlayer = 1;
  ...
  private int GetNextGamePlayerId() => RewiredControllerManager.gamePlayerIdCounter++;

  internal List<RewiredControllerManager.PlayerMap> GetActiveDevices() => RewiredControllerManager.playerMaps;

  internal IList<Player> GetPlayers() => ReInput.players.GetPlayers();
  ...
  internal void ClearAssignedControllers()
  {
    foreach (RewiredControllerManager.PlayerMap playerMap in RewiredControllerManager.playerMaps)
  ...
  internal void AssignControllerToPlayer(int i, int controllerIndex) => RewiredControllerManager.playerMaps.First<RewiredControllerManager.PlayerMap>((Func<RewiredControllerManager.PlayerMap, bool>) (x => x.rewiredPlayerId == controllerIndex)).gamePlayerId = i;

  public bool AnyControllerConnected() => RewiredControllerManager.playerMaps.Count > 0;

  internal bool IsButtonPressed(string input = "", bool IsPositive = true)
  {
    if (!this.enabled)
      return false;
    int callingPlayer = -1;
  ...
  internal bool IsButtonPressed(out int callingPlayer, string input = "", bool IsPositive = true)
  {
    bool state = false;
    callingPlayer = -1;
    if (IsPositive)
  ...
  internal bool IsButtonHeld(string input = "", bool IsPositive = true)
  {
    if (!this.enabled)
      return false;
    int callingPlayer = -1;
  ...
  internal bool IsButtonHeld(out int callingPlayer, string input = "", bool IsPositive = true)
  {
    bool state = false;
    callingPlayer = -1;
    if (IsPositive)
  ...
  internal bool IsButtonLongHeld(string input = "", bool IsPositive = true)
  {
    if (!this.enabled)
      return false;
    int callingPlayer = -1;
  ...
  internal bool IsButtonLongHeld(out int callingPlayer, string input = "", bool IsPositive = true)
  {
    bool state = false;
    callingPlayer = -1;
    if (IsPositive)
  ...
  internal bool IsButtonReleased(string input = "", bool IsPositive = true)
  {
    if (!this.enabled)
      return false;
    int callingPlayer = -1;
  ...
  internal bool IsButtonReleased(out int callingPlayer, string input = "", bool IsPositive = true)
  {
    bool state = false;
    callingPlayer = -1;
    if (IsPositive)
  ...
  internal bool WasButtonReleased(string input = "", bool IsPositive = true)
  {
    int callingPlayer = -1;
    return this.WasButtonReleased(out callingPlayer, input, IsPositive);
  }

  internal bool WasButtonReleased(out int callingPlayer, string input = "", bool IsPositive = true)
  {
    bool state = false;
    callingPlayer = -1;
    if (IsPositive)
  ...
  internal bool WasButtonPressed(string input = "", bool IsPositive = true)
  {
    int callingPlayer = -1;
    return this.WasButtonPressed(out callingPlayer, input, IsPositive);
  }

  internal bool WasButtonPressed(out int callingPlayer, string input = "", bool IsPositive = true)
  {
    bool state = false;
    callingPlayer = -1;
    if (IsPositive)
  ...
  internal float GetAnalogPositive(string input = "")
  {
    if (!this.enabled)
      return 0.0f;
    int callingPlayer = -1;
  ...
  internal float GetAnalogNegative(string input = "")
  {
    if (!this.enabled)
      return 0.0f;
    int callingPlayer = -1;
  ...
  internal float GetAnalog(string input = "")
  {
    if (!this.enabled)
      return 0.0f;
    float f = 0.0f;
  ...
  internal float GetAnalog(out int callingPlayer, string input, bool lookingForPositive)
  {
    float analog = 0.0f;
    callingPlayer = -1;
    foreach (Player player in (IEnumerable<Player>) ReInput.players.GetPlayers())
  ...
  private void ReturnTrueWithPlayer(out int callingPlayer, out bool state, Player x)
  {
    callingPlayer = RewiredControllerManager.playerMaps.Count<RewiredControllerManager.PlayerMap>((Func<RewiredControllerManager.PlayerMap, bool>) (y => y.rewiredPlayerId == x.id)) <= 0 ? -1 : RewiredControllerManager.playerMaps.First<RewiredControllerManager.PlayerMap>((Func<RewiredControllerManager.PlayerMap, bool>) (y => y.rewiredPlayerId == x.id)).gamePlayerId;
    state = true;
  }

  internal int GetDeviceCount() => RewiredControllerManager.playerMaps.Count<RewiredControllerManager.PlayerMap>();

  internal void SetActiveControllersToMap(string newControllerMap)
  {
