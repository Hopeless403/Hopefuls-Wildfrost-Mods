...
public abstract class StatusEffectApplyX : StatusEffectData
{
  ...
  protected override bool CanTrigger() => base.CanTrigger() && this.dealDamage || (bool) (UnityEngine.Object) this.effectToApply;
  ...
  protected bool AppliesTo(StatusEffectApplyX.ApplyToFlags applyTo) => (this.applyToFlags & applyTo) != 0;
...
label_18:
  ...
  private bool CanAffect(Entity entity) => !this.dealDamage ? this.effectToApply.CanPlayOn(entity) : entity.canBeHit;

  private bool CheckConstraints(Entity entity) => this.CanAffect(entity) && ((IEnumerable<TargetConstraint>) this.applyConstraints).All<TargetConstraint>((Func<TargetConstraint, bool>) (c => c.Check(entity)));
