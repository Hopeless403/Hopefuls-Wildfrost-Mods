...
{
  [SerializeField]
  private FinalBossGenerationSettings settings;
  [SerializeField]
  private CardType leaderCardType;
  [SerializeField]
  private CardType enemyCardType;
  [Header("Waves")]
  [SerializeField]
  private int waveCount = 3;
  [SerializeField]
  private int leaderWave;
  [SerializeField]
  private int bossWave = 3;
  [SerializeField]
  private int[] waveMaxSize = new int[3]{ 6, 6, 6 };
  [SerializeField]
  private bool insertBossAtFront;
  [SerializeField]
  private bool insertLeaderAtFront;
  [Header("Boss")]
  [SerializeField]
  private CardData[] bossOptions;
  [SerializeField]
  private StatusEffectData[] leaderNextPhase;
  [Header("Default Deck")]
  [SerializeField]
  private CardData[] defaultLeaderOptions;
  [SerializeField]
  private bool processDefaultLeader;
  [SerializeField]
  private CardData[] defaultDeck;
  ...
  public CardData[] LoadCards(GameMode gameMode)
  {
    ...
    return data == null ? (CardData[]) null : data.LoadArray<CardData, CardSaveData>();
  }
    ...
    out CardData bossCloned)
  {
    ...
    if (!hasStoredCards)
    {
      ...
      if (this.defaultLeaderOptions.Length != 0)
      {
        hasLeader = true;
