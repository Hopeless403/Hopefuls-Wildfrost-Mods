...
public class ModifierSystem : GameSystem
{
  ...
  private static IEnumerator RunInitScripts() => ModifierSystem.RunInitScripts((IReadOnlyCollection<GameModifierData>) Campaign.Data.Modifiers);

  private async Task RunStartScripts()
  {
  ...
  private static IEnumerator RunInitScripts(IReadOnlyCollection<GameModifierData> modifiers)
  {
    if (modifiers != null)
    {
  ...
  private static IEnumerator RunCampaignStartScripts(IReadOnlyCollection<GameModifierData> modifiers)
  {
    if (modifiers != null)
    {
