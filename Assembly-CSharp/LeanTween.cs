...
public class LeanTween : MonoBehaviour
{
  ...
  private static void onLevelWasLoaded54(Scene scene, LoadSceneMode mode) => LeanTween.internalOnLevelWasLoaded(scene.buildIndex);

  private static void internalOnLevelWasLoaded(int lvl) => LTGUI.reset();
