...
public class UINavigationSystem : MonoBehaviourSingleton<UINavigationSystem>
{
  ...
  private void Events_OnTransitionEnd(TransitionType transition) => UINavigationDefaultSystem.SetStartingItem(false, true);

  internal void RemoveActiveLayer() => this.UnregisterNavigationLayer(UINavigationSystem.ActiveNavigationLayer);
