...
public static class Scores
{
  ...
  private static async Task<Leaderboard?> GetLeaderboard(string leaderboardName) => !SteamManager.init ? new Leaderboard?() : await SteamUserStats.FindOrCreateLeaderboardAsync(leaderboardName, LeaderboardSort.Descending, LeaderboardDisplay.Numeric);
