...
public class StatusEffectTriggerWhenAllyAttacks : StatusEffectReaction
{
  ...
  private bool CheckEntity(Entity entity) => (bool) (Object) entity && entity.owner.team == this.target.owner.team && (Object) entity != (Object) this.target && this.CheckRow(entity) && Battle.IsOnBoard(entity) && this.CheckDuplicate(entity) && this.CheckDuplicate(entity.triggeredBy);

  private bool CheckRow(Entity entity) => !this.allyInRow || ((IList<CardContainer>) entity.containers).ContainsAny<CardContainer>((IEnumerable<CardContainer>) this.target.containers);
