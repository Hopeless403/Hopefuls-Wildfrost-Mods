...
public class CampaignGenerator : ScriptableObject
{
  ...
  private string seed;
  [SerializeField]
  protected Vector2 nodeSizeRange = new Vector2(1.8f, 2f);
  [SerializeField]
  protected float nodeCreationRand = 1.5f;
  [SerializeField]
  protected Vector2 nodeSpacing = new Vector2(3.2f, 2f);
  [SerializeField]
  protected Vector2 battleDistanceRange = new Vector2(13f, 14f);
  [SerializeField]
  protected Vector2 mapDirection = new Vector2(0.67f, 0.33f);
  [SerializeField]
  protected TextAsset[] presets;
  [SerializeField]
  protected bool instant = true;
  [SerializeField]
  protected bool restart;
  [SerializeField]
  protected bool restartOnError = true;
  ...
  protected TextAsset ChoosePreset() => this.presets.Length != 0 ? this.presets.RandomItem<TextAsset>() : throw new Exception("Campaign Generation Error: No Presets Found!");

  protected static string[] GetPresetLines(TextAsset preset)
  {
  ...
  protected static int GetCampaignLength(string[] lines)
  {
  ...
  protected CampaignGenerator.Node CreateNode(
    float x,
    float y,
  ...
  protected static void ShuffleNodes(List<CampaignGenerator.Node> nodes)
  {
    bool flag = true;
  ...
  protected static bool LineIntersectsCircle(
