...
public class WaveDeployerDots : MonoBehaviour
{
  ...
  private Vector3 GetPosition(int index) => (Vector3) Lengthdir.ToVector2(this.fanRadius, (float) (((double) this.GetAngle(index) + (double) this.startAngle) * (Math.PI / 180.0)));
