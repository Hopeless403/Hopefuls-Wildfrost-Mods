...
public class BattleLogSystem : GameSystem
{
  ...
  private static readonly Dictionary<string, string> damageTypes = new Dictionary<string, string>()
  {
    {
      "shroom",
      "<sprite name=shroom>"
  ...
  [SerializeField]
  private LocalizedString logTurnKey;
  [SerializeField]
  private LocalizedString logHitKey;
  [SerializeField]
  private LocalizedString logDamageKey;
  [SerializeField]
  private LocalizedString logSpecialDamageKey;
  [SerializeField]
  private LocalizedString logDestroyKey;
  [SerializeField]
  private LocalizedString logConsumedKey;
  [SerializeField]
  private LocalizedString logEatenKey;
  [SerializeField]
  private LocalizedString logSacrificedKey;
  [SerializeField]
  private LocalizedString logBlockKey;
  [SerializeField]
  private LocalizedString logStatusKey;
  [SerializeField]
  private LocalizedString logStatusFromKey;
  [SerializeField]
  private LocalizedString logHealKey;
  [SerializeField]
  private LocalizedString logRestoredKey;
  [SerializeField]
  private LocalizedString logBoostKey;
  [SerializeField]
  private LocalizedString logDamageUpKey;
  [SerializeField]
  private LocalizedString logDamageUpSelfKey;
  [SerializeField]
  private LocalizedString logDamageDownKey;
  [SerializeField]
  private LocalizedString logDamageDownSelfKey;
  [SerializeField]
  private LocalizedString logHealthUpKey;
  [SerializeField]
  private LocalizedString logHealthUpSelfKey;
  [SerializeField]
  private LocalizedString logHealthDownKey;
  [SerializeField]
  private LocalizedString logHealthDownSelfKey;
  [SerializeField]
  private LocalizedString logCounterUpKey;
  [SerializeField]
  private LocalizedString logCounterUpSelfKey;
  [SerializeField]
  private LocalizedString logCounterDownKey;
  [SerializeField]
  private LocalizedString logCounterDownSelfKey;
  [SerializeField]
  private LocalizedString logEnterBattleKey;
  [SerializeField]
  private LocalizedString logRecalledKey;
  [SerializeField]
  private LocalizedString logSummonedKey;
  [SerializeField]
  private LocalizedString logBattleWinKey;
  [SerializeField]
  private LocalizedString logBattleLoseKey;
  [SerializeField]
  private LocalizedString logFleeKey;
  ...
  private void TurnEnd(int turnNumber)
  {
  ...
  private void PostHit(global::Hit hit)
  {
  ...
  private void EntityFlee(Entity entity) => this.Log(this.logFleeKey, BattleLogType.Flee, (object) BattleLogSystem.GetBattleEntity(entity));
  ...
  private void LogHit(Entity attacker, Entity target, int damage, string damageType)
  {
  ...
  private void LogDamage(Entity target, int damage, string damageType)
  {
    if (damage <= 0)
      return;
    string str;
  ...
  private void LogBlock(Entity target, int damageBlocked) => this.Log(this.logBlockKey, BattleLogType.Buff, (object) BattleLogSystem.GetBattleEntity(target), (object) damageBlocked);

  private void LogStatus(Entity applier, Entity target, StatusEffectData status, int count)
  {
    if (!status.isStatus)
      return;
  ...
  private void LogHeal(Entity healer, Entity target) => this.Log(this.logHealKey, BattleLogType.Heal, (object) BattleLogSystem.GetBattleEntity(healer), (object) BattleLogSystem.GetBattleEntity(target));

  private void LogRestore(Entity target, int amount) => this.Log(this.logRestoredKey, BattleLogType.Heal, (object) BattleLogSystem.GetBattleEntity(target), (object) amount);

  private void LogDamageUp(Entity applier, Entity target, int amount)
  {
  ...
  private void LogDamageDown(Entity applier, Entity target, int amount)
  {
    if (!(bool) (Object) applier || (Object) applier == (Object) target)
  ...
  private void LogHealthUp(Entity applier, Entity target, int amount)
  {
    if (!(bool) (Object) applier || (Object) applier == (Object) target)
  ...
  private void LogHealthDown(Entity applier, Entity target, int amount)
  {
    if (!(bool) (Object) applier || (Object) applier == (Object) target)
  ...
  private void LogCounterUp(Entity applier, Entity target, int amount)
  {
    if (!(bool) (Object) applier || (Object) applier == (Object) target)
  ...
  private void LogCounterDown(Entity applier, Entity target, int amount)
  {
    if (!(bool) (Object) applier || (Object) applier == (Object) target)
  ...
  private void Log(LocalizedString textKey, BattleLogType type, params object[] args) => this.list.Add(new BattleLog()
  {
    textKey = textKey,
    type = type,
    args = args
