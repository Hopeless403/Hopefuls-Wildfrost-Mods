  ...
  IPointerExitHandler
{
  ...
  private UpgradeDisplay upgradeDisplay => this._upgradeDisplay ?? (this._upgradeDisplay = this.GetComponent<UpgradeDisplay>());

  private bool DragHandlerDragging => (bool) (Object) this.dragHandler && this.dragHandler.IsDragging;
