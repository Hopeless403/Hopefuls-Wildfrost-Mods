...
{
  private readonly Dictionary<string, CharacterRewards.Pool> poolLookup = new Dictionary<string, CharacterRewards.Pool>();
  ...
  public class Pool
  {
    private readonly List<DataFile> current = new List<DataFile>();

    public List<DataFile> list { get; private set; }
    ...
    private void Populate() => this.current.AddRange((IEnumerable<DataFile>) this.list.InRandomOrder<DataFile>());
  }
}
