...
public class Fitter : MonoBehaviourRect
{
  ...
  protected void SetSize(float w, float h) => this.rectTransform.sizeDelta = new Vector2(w, h) + this.padding;

  protected virtual IEnumerator FitRoutine(System.Action onComplete)
  {
    Fitter fitter = this;
  ...
  protected IEnumerator UpdateLinkedFitters()
  {
