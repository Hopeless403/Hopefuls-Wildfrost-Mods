...
{
  [SerializeField]
  private KeyCode[] toggle = new KeyCode[2]
  {
    KeyCode.BackQuote,
    KeyCode.F12
  };
  [SerializeField]
  private KeyCode takePredict = KeyCode.Tab;
  [SerializeField]
  private Color logColor;
  [SerializeField]
  private Color logErrorColor;
  [SerializeField]
  private string unknownCommandFormat = "Unknown Command: {0}";
  [SerializeField]
  ...
  [SerializeField]
  private ConsoleArgsDisplay argsDisplay;
  [Header("Saving Commands")]
  [SerializeField]
  private KeyCode[] saveKeys = new KeyCode[8]
  {
    KeyCode.F1,
    KeyCode.F2,
    KeyCode.F3,
  ...
  [SerializeField]
  private string saveFileName = "commands.sav";
  [SerializeField]
  private string[] savedCommands;
  private static readonly List<string> previous = new List<string>();
  private int preIndex;
  private static List<Console.Command> commands;
  public static bool active;
  private static Entity hover;
  private static CardSlot slotHover;
  private bool promptUpdatePredict;
  ...
  private IEnumerator UpdatePredictRoutine()
  {
    while (true)
    {
  ...
  private static void Hover(Entity entity) => Console.hover = entity;

  private static void SlotHover(CardSlot slot) => Console.slotHover = slot;
  ...
  private void CheckScrollPrevious()
  {
  ...
  private void CheckRunSavedCommands()
  {
  ...
  private static void Commands() => Console.commands = new List<Console.Command>()
  {
  ...
  private void SaveCommands() => File.WriteAllLines(Application.persistentDataPath + "\\" + this.saveFileName, this.savedCommands);
  ...
  private IEnumerator PredictArgsRoutine(string text)
  {
    text = text.TrimStart();
    if (text.Length > 0)
    {
  ...
  private static Console.Command GetExactCommand(string text) => Console.commands.FirstOrDefault<Console.Command>((Func<Console.Command, bool>) (a => text.StartsWith(a.id + " ")));
  ...
  private static void ToggleHelp() => MonoBehaviourSingleton<Console>.instance.helpWindow.SetActive(!MonoBehaviourSingleton<Console>.instance.helpWindow.activeSelf);
  ...
  public abstract class Command
  {
    ...
    protected void FailCannotUse() => this.Fail("Cannot use [" + this.id + "] command here");

    protected bool TryGetPlayer(out Character player, bool doFail = true)
    {
    ...
    protected static string[] Split(string text) => text.Length <= 0 ? new string[1]
    {
      ""
    } : text.Split(new char[1]{ ' ' }, StringSplitOptions.RemoveEmptyEntries);
  }

  private class CommandHelp : Console.Command
  {
  ...
  private class CommandRepeat : Console.Command
  {
    ...
    private static IEnumerator Repeat(string command, int repeats)
    {
      while (repeats > 0)
      {
        --repeats;
  ...
  private class CommandGainCard : Console.Command
  {
...
label_7:
  ...
  private class CommandGainUpgrade : Console.Command
  {
  ...
  private class CommandGainGold : Console.Command
  {
  ...
  private class CommandSpawn : Console.Command
  {
  ...
  private class CommandBattleWin : Console.Command
  {
  ...
  private class CommandBattleLose : Console.Command
  {
  ...
  private class CommandBattleSkip : Console.Command
  {
  ...
  private class CommandBattleAuto : Console.Command
  {
  ...
  private class CommandSkipTurn : Console.Command
  {
  ...
  private class CommandSetHealth : Console.Command
  {
  ...
  private class CommandSetAttack : Console.Command
  {
  ...
  private class CommandSetCounter : Console.Command
  {
  ...
  private class CommandAddStatus : Console.Command
  {
...
label_9:;
  ...
  private class CommandAddUpgrade : Console.Command
  {
  ...
  private class CommandDestroy : Console.Command
  {
  ...
  private class CommandDestroyAll : Console.Command
  {
  ...
  private class CommandHit : Console.Command
  {
  ...
  private class CommandKill : Console.Command
  {
  ...
  private class CommandKillAll : Console.Command
  {
  ...
  private class CommandReroll : Console.Command
  {
  ...
  private class CommandSystemDisable : Console.Command
  {
  ...
  private class CommandSystemEnable : Console.Command
  {
  ...
  private class CommandGameSpeed : Console.Command
  {
  ...
  private class CommandMapJump : Console.Command
  {
  ...
  private class CommandMapInfo : Console.Command
  {
  ...
  private class CommandSetSaveProfile : Console.Command
  {
  ...
  private class CommandVolume : Console.Command
  {
    private readonly string busName;
    private readonly string internalId = "volume";
    private readonly string internalFormat = "volume <0-1>";
  ...
  private abstract class CommandOptions : Console.Command
  {
    public override string format => this.id + " <" + string.Join("/", this.options) + ">";

    protected virtual string[] options => new string[2]
    {
      "on",
      "off"
    };
  ...
  private abstract class CommandToggle : Console.CommandOptions
  {
    public override void Run(string args)
    {
      switch (args.ToLower())
  ...
  private class CommandToggleHUD : Console.CommandToggle
  {
    public override string id => "hud";

    protected override void TurnOn() => Settings.Save<float>("HudAlpha", 1f);

    protected override void TurnOff() => Settings.Save<float>("HudAlpha", 0.0f);
  }

  private class CommandToggleFps : Console.CommandToggle
  {
    public override string id => "fps";

    protected override void TurnOn() => Settings.Save<bool>("ShowFps", true);

    protected override void TurnOff() => Settings.Save<bool>("ShowFps", false);
  }

  private class CommandCursor : Console.CommandOptions
  {
    public override string id => "cursor";

    protected override string[] options => new string[3]
    {
      "off",
      "game",
      "system"
  ...
  private class CommandToggleHandOverlay : Console.CommandToggle
  {
    public override string id => "handoverlay";

    protected override void TurnOn() => Settings.Save<bool>("HideHandOverlay", false);

    protected override void TurnOff() => Settings.Save<bool>("HideHandOverlay", true);
  }

  private class CommandPrompt : Console.Command
  {
  ...
  private class CommandPromptHide : Console.Command
  {
  ...
  private class CommandErrorTest : Console.Command
  {
  ...
  private class CommandPanSpeed : Console.Command
  {
  ...
  private class CommandNextBattle : Console.Command
  {
  ...
  private class CommandProgressGain : Console.Command
  {
  ...
  private class CommandProgressReset : Console.Command
  {
  ...
  private class LoadModCommand : Console.Command
  {
  ...
  private class PublishMod : Console.Command
  {
  ...
  private class UnLoadModCommand : Console.Command
  {
  ...
  private class CommandScreenshot : Console.Command
  {
  ...
  private class CommandBlood : Console.Command
  {
    ...
    private static IEnumerator Create(Vector3 pos, bool setColor, Color color)
    {
  ...
  private class CommandRunFinalBossScript : Console.Command
  {
  ...
  private class CommandDailyReset : Console.Command
  {
  ...
  private class CommandDailyOffset : Console.Command
  {
  ...
  private class CommandEncrypt : Console.Command
  {
  ...
  private class CommandDecrypt : Console.Command
  {
  ...
  private class CommandDisplay : Console.Command
  {
