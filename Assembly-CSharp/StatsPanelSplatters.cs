...
{
  [SerializeField]
  private Sprite[] splatterSprites;
  [SerializeField]
  private ImageSprite[] splatters;
  private static readonly StatsPanelSplatters.Profile[] profiles = new StatsPanelSplatters.Profile[8]
  {
  ...
  private readonly List<StatsPanelSplatters.Profile> profilePool = new List<StatsPanelSplatters.Profile>();
  ...
  private StatsPanelSplatters.Profile PullProfile()
  {
