...
public class CardPopUpPanel : Tooltip
{
  [Header("Text")]
  [SerializeField]
  private float titleSize = 0.3f;
  [SerializeField]
  private float iconSize = 0.275f;
  [SerializeField]
  private float bodySize = 0.25f;
  [SerializeField]
  private float noteSize = 0.21f;
  [SerializeField]
  private TextMeshProUGUI textElement;
  [SerializeField]
  private Fitter fitter;
  private static readonly Color defaultTitleColor = new Color(1f, 0.7921569f, 0.3411765f, 1f);
  private static readonly Color defaultBodyColor = Color.white;
  private static readonly Color defaultNoteColor = new Color(0.65f, 0.65f, 0.65f);
