...
{
  private static readonly List<GameObject> unhoverCache = new List<GameObject>();
  ...
  private void CardControllerEnabled(CardController controller) => this.ForceSetMousePosition(CustomInputModule.offscreen);

  private void ForceSetMousePosition(Vector2 position)
  {
  ...
  private PointerInputModule.MouseState GetMousePointerEventDataWithPosition(Vector2 forcePosition)
  {
  ...
  private static void CustomHandlePointerExitAndEnter(
