...
public class UINavigationItem : MonoBehaviour
{
  ...
  private bool hasLayerBeenChecked;
  private Camera _cam;
  ...
  private void OnRemoved() => MonoBehaviourSingleton<UINavigationSystem>.instance.UnregisterSelectable(this);
  ...
  private void CheckForReferences(bool isFirstTime)
  {
  ...
  internal void CheckForNavigationLayer(bool isFirstTime)
  {
    if (isFirstTime)
      this.navigationLayer = (UINavigationLayer) null;
  ...
  internal void CheckForNavigationLayer(Transform checkTransform, bool isFirstTime)
  {
  ...
  internal void CheckForSelectable()
  {
  ...
  internal void CheckForSelectableDown(Transform checkTransform)
  {
  ...
  internal void CheckForSelectableUp(Transform checkTransform)
  {
