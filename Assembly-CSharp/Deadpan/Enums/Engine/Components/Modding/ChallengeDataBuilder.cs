...
namespace Deadpan.Enums.Engine.Components.Modding
{
  public class ChallengeDataBuilder : DataFileBuilder<ChallengeData, ChallengeDataBuilder>
  {
    ...
    public override ChallengeDataBuilder Create(string name)
    {
      if (this.Mod != null)
        name = Extensions.PrefixGUID(name, this.Mod);
      if (this._data != null)
        UnityEngine.Object.Destroy((UnityEngine.Object) this._data);
      this._data = ScriptableObject.CreateInstance<ChallengeData>();
    ...
    {
      this._data.listener = Extensions.GetChallengeListener(listener);
      return this;
    }
    ...
    {
      this._data.requires = ((IEnumerable<string>) requires).Select<string, ChallengeData>(new Func<string, ChallengeData>(Extensions.GetChallengeData)).ToArray<ChallengeData>();
      return this;
    }
    ...
    {
      this._data.reward = Extensions.GetUnlockData(reward);
      return this;
    }
  }
}
