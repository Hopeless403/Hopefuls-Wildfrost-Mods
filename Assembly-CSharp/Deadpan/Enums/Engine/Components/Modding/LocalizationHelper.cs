  ...
  public static class LocalizationHelper
  {
    ...
    public static StringTable GetCollection(string name, LocaleIdentifier identifier)
    {
      ...
      if (LocalizationHelper.stringTables.TryGetValue(key, out collection2))
        return collection2;
      StringTable stringTable1 = new StringTable();
      stringTable1.name = key;
      stringTable1.LocaleIdentifier = identifier;
      StringTable collection3 = stringTable1;
      StringTable stringTable2 = Addressables.LoadAssetAsync<StringTable>((object) (name + "_" + new LocaleIdentifier(SystemLanguage.English).Code)).WaitForCompletion();
      collection3.SharedData = stringTable2.SharedData;
      LocalizationHelper.stringTables.Add(key, collection3);
      return collection3;
    }
