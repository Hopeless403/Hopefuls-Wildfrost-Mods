...
public class FontSetterSystem : GameSystem
{
  ...
  private void OnEnable() => LocalizationSettings.Instance.OnSelectedLocaleChanged += new Action<Locale>(FontSetterSystem.LocaleChanged);

  private void OnDisable() => LocalizationSettings.Instance.OnSelectedLocaleChanged -= new Action<Locale>(FontSetterSystem.LocaleChanged);
