...
public class JournalCharmManager : MonoBehaviour
{
  ...
  private List<KeyValuePair<string, CardUpgradeData>> LoadCharmData() => AddressableLoader.GetGroup<CardUpgradeData>("CardUpgradeData").Where<CardUpgradeData>((Func<CardUpgradeData, bool>) (a => a.type == CardUpgradeData.Type.Charm && a.tier >= -2)).ToDictionary<CardUpgradeData, string, CardUpgradeData>((Func<CardUpgradeData, string>) (a => a.title), (Func<CardUpgradeData, CardUpgradeData>) (a => a)).OrderByDescending<KeyValuePair<string, CardUpgradeData>, bool>((Func<KeyValuePair<string, CardUpgradeData>, bool>) (a => a.Value.tier >= 0)).ThenBy<KeyValuePair<string, CardUpgradeData>, string>((Func<KeyValuePair<string, CardUpgradeData>, string>) (a => a.Key)).ToList<KeyValuePair<string, CardUpgradeData>>();
}
