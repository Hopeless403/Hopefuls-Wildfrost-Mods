...
label_16:
  ...
  private static GameObject GetPrefab(CharacterType type, string name, int index)
  {
    if (index >= 0)
    {
  ...
  private static Sprite GetSprite(CharacterType type, string name, int index)
  {
    if (index >= 0)
    {
  ...
  private static ColorSet GetColorSet(CharacterType type, string name, int index)
  {
    if (index >= 0)
    {
  ...
  private static void SetTexturePixels(
    CharacterType type,
    Texture2D texture,
