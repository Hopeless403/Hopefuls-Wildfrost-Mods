...
namespace Rewired
{
  public sealed class HOTASTemplate : ControllerTemplate, IHOTASTemplate, IControllerTemplate
  {
    ...
    IControllerTemplateButton IHOTASTemplate.stickTrigger => this.GetElement<IControllerTemplateButton>(3);

    IControllerTemplateButton IHOTASTemplate.stickTriggerStage2 => this.GetElement<IControllerTemplateButton>(4);

    IControllerTemplateButton IHOTASTemplate.stickPinkyButton => this.GetElement<IControllerTemplateButton>(5);

    IControllerTemplateButton IHOTASTemplate.stickPinkyTrigger => this.GetElement<IControllerTemplateButton>(154);

    IControllerTemplateButton IHOTASTemplate.stickButton1 => this.GetElement<IControllerTemplateButton>(6);

    IControllerTemplateButton IHOTASTemplate.stickButton2 => this.GetElement<IControllerTemplateButton>(7);

    IControllerTemplateButton IHOTASTemplate.stickButton3 => this.GetElement<IControllerTemplateButton>(8);

    IControllerTemplateButton IHOTASTemplate.stickButton4 => this.GetElement<IControllerTemplateButton>(9);

    IControllerTemplateButton IHOTASTemplate.stickButton5 => this.GetElement<IControllerTemplateButton>(10);

    IControllerTemplateButton IHOTASTemplate.stickButton6 => this.GetElement<IControllerTemplateButton>(11);

    IControllerTemplateButton IHOTASTemplate.stickButton7 => this.GetElement<IControllerTemplateButton>(12);

    IControllerTemplateButton IHOTASTemplate.stickButton8 => this.GetElement<IControllerTemplateButton>(13);

    IControllerTemplateButton IHOTASTemplate.stickButton9 => this.GetElement<IControllerTemplateButton>(14);

    IControllerTemplateButton IHOTASTemplate.stickButton10 => this.GetElement<IControllerTemplateButton>(15);

    IControllerTemplateButton IHOTASTemplate.stickBaseButton1 => this.GetElement<IControllerTemplateButton>(18);

    IControllerTemplateButton IHOTASTemplate.stickBaseButton2 => this.GetElement<IControllerTemplateButton>(19);

    IControllerTemplateButton IHOTASTemplate.stickBaseButton3 => this.GetElement<IControllerTemplateButton>(20);

    IControllerTemplateButton IHOTASTemplate.stickBaseButton4 => this.GetElement<IControllerTemplateButton>(21);

    IControllerTemplateButton IHOTASTemplate.stickBaseButton5 => this.GetElement<IControllerTemplateButton>(22);

    IControllerTemplateButton IHOTASTemplate.stickBaseButton6 => this.GetElement<IControllerTemplateButton>(23);

    IControllerTemplateButton IHOTASTemplate.stickBaseButton7 => this.GetElement<IControllerTemplateButton>(24);

    IControllerTemplateButton IHOTASTemplate.stickBaseButton8 => this.GetElement<IControllerTemplateButton>(25);

    IControllerTemplateButton IHOTASTemplate.stickBaseButton9 => this.GetElement<IControllerTemplateButton>(26);

    IControllerTemplateButton IHOTASTemplate.stickBaseButton10 => this.GetElement<IControllerTemplateButton>(27);

    IControllerTemplateButton IHOTASTemplate.stickBaseButton11 => this.GetElement<IControllerTemplateButton>(161);

    IControllerTemplateButton IHOTASTemplate.stickBaseButton12 => this.GetElement<IControllerTemplateButton>(162);
    ...
    IControllerTemplateButton IHOTASTemplate.throttleButton1 => this.GetElement<IControllerTemplateButton>(50);

    IControllerTemplateButton IHOTASTemplate.throttleButton2 => this.GetElement<IControllerTemplateButton>(51);

    IControllerTemplateButton IHOTASTemplate.throttleButton3 => this.GetElement<IControllerTemplateButton>(52);

    IControllerTemplateButton IHOTASTemplate.throttleButton4 => this.GetElement<IControllerTemplateButton>(53);

    IControllerTemplateButton IHOTASTemplate.throttleButton5 => this.GetElement<IControllerTemplateButton>(54);

    IControllerTemplateButton IHOTASTemplate.throttleButton6 => this.GetElement<IControllerTemplateButton>(55);

    IControllerTemplateButton IHOTASTemplate.throttleButton7 => this.GetElement<IControllerTemplateButton>(56);

    IControllerTemplateButton IHOTASTemplate.throttleButton8 => this.GetElement<IControllerTemplateButton>(57);

    IControllerTemplateButton IHOTASTemplate.throttleButton9 => this.GetElement<IControllerTemplateButton>(58);

    IControllerTemplateButton IHOTASTemplate.throttleButton10 => this.GetElement<IControllerTemplateButton>(59);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton1 => this.GetElement<IControllerTemplateButton>(60);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton2 => this.GetElement<IControllerTemplateButton>(61);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton3 => this.GetElement<IControllerTemplateButton>(62);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton4 => this.GetElement<IControllerTemplateButton>(63);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton5 => this.GetElement<IControllerTemplateButton>(64);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton6 => this.GetElement<IControllerTemplateButton>(65);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton7 => this.GetElement<IControllerTemplateButton>(66);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton8 => this.GetElement<IControllerTemplateButton>(67);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton9 => this.GetElement<IControllerTemplateButton>(68);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton10 => this.GetElement<IControllerTemplateButton>(69);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton11 => this.GetElement<IControllerTemplateButton>(132);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton12 => this.GetElement<IControllerTemplateButton>(133);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton13 => this.GetElement<IControllerTemplateButton>(134);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton14 => this.GetElement<IControllerTemplateButton>(135);

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton15 => this.GetElement<IControllerTemplateButton>(136);

    IControllerTemplateAxis IHOTASTemplate.throttleSlider1 => this.GetElement<IControllerTemplateAxis>(70);

    IControllerTemplateAxis IHOTASTemplate.throttleSlider2 => this.GetElement<IControllerTemplateAxis>(71);

    IControllerTemplateAxis IHOTASTemplate.throttleSlider3 => this.GetElement<IControllerTemplateAxis>(72);

    IControllerTemplateAxis IHOTASTemplate.throttleSlider4 => this.GetElement<IControllerTemplateAxis>(73);

    IControllerTemplateAxis IHOTASTemplate.throttleDial1 => this.GetElement<IControllerTemplateAxis>(74);

    IControllerTemplateAxis IHOTASTemplate.throttleDial2 => this.GetElement<IControllerTemplateAxis>(142);

    IControllerTemplateAxis IHOTASTemplate.throttleDial3 => this.GetElement<IControllerTemplateAxis>(143);

    IControllerTemplateAxis IHOTASTemplate.throttleDial4 => this.GetElement<IControllerTemplateAxis>(144);

    IControllerTemplateButton IHOTASTemplate.throttleWheel1Forward => this.GetElement<IControllerTemplateButton>(145);

    IControllerTemplateButton IHOTASTemplate.throttleWheel1Back => this.GetElement<IControllerTemplateButton>(146);

    IControllerTemplateButton IHOTASTemplate.throttleWheel1Press => this.GetElement<IControllerTemplateButton>(147);

    IControllerTemplateButton IHOTASTemplate.throttleWheel2Forward => this.GetElement<IControllerTemplateButton>(148);

    IControllerTemplateButton IHOTASTemplate.throttleWheel2Back => this.GetElement<IControllerTemplateButton>(149);

    IControllerTemplateButton IHOTASTemplate.throttleWheel2Press => this.GetElement<IControllerTemplateButton>(150);

    IControllerTemplateButton IHOTASTemplate.throttleWheel3Forward => this.GetElement<IControllerTemplateButton>(151);

    IControllerTemplateButton IHOTASTemplate.throttleWheel3Back => this.GetElement<IControllerTemplateButton>(152);

    IControllerTemplateButton IHOTASTemplate.throttleWheel3Press => this.GetElement<IControllerTemplateButton>(153);

    IControllerTemplateAxis IHOTASTemplate.leftPedal => this.GetElement<IControllerTemplateAxis>(168);

    IControllerTemplateAxis IHOTASTemplate.rightPedal => this.GetElement<IControllerTemplateAxis>(169);

    IControllerTemplateAxis IHOTASTemplate.slidePedals => this.GetElement<IControllerTemplateAxis>(170);

    IControllerTemplateStick IHOTASTemplate.stick => this.GetElement<IControllerTemplateStick>(171);

    IControllerTemplateThumbStick IHOTASTemplate.stickMiniStick1 => this.GetElement<IControllerTemplateThumbStick>(172);

    IControllerTemplateThumbStick IHOTASTemplate.stickMiniStick2 => this.GetElement<IControllerTemplateThumbStick>(173);
    ...
    IControllerTemplateHat IHOTASTemplate.stickHat3 => this.GetElement<IControllerTemplateHat>(176);

    IControllerTemplateHat IHOTASTemplate.stickHat4 => this.GetElement<IControllerTemplateHat>(177);

    IControllerTemplateThrottle IHOTASTemplate.throttle1 => this.GetElement<IControllerTemplateThrottle>(178);

    IControllerTemplateThrottle IHOTASTemplate.throttle2 => this.GetElement<IControllerTemplateThrottle>(179);

    IControllerTemplateThumbStick IHOTASTemplate.throttleMiniStick => this.GetElement<IControllerTemplateThumbStick>(180);

    IControllerTemplateHat IHOTASTemplate.throttleHat1 => this.GetElement<IControllerTemplateHat>(181);

    IControllerTemplateHat IHOTASTemplate.throttleHat2 => this.GetElement<IControllerTemplateHat>(182);

    IControllerTemplateHat IHOTASTemplate.throttleHat3 => this.GetElement<IControllerTemplateHat>(183);

    IControllerTemplateHat IHOTASTemplate.throttleHat4 => this.GetElement<IControllerTemplateHat>(184);
