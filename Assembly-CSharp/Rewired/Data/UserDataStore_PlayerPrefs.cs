...
namespace Rewired.Data
{
  public class UserDataStore_PlayerPrefs : UserDataStore
  {
    ...
    private string GetInputBehaviorPlayerPrefsKey(Player player, int inputBehaviorId) => this.GetBasePlayerPrefsKey(player) + "|dataType=InputBehavior" + "|id=" + inputBehaviorId.ToString();
