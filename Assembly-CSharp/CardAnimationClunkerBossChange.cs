...
public class CardAnimationClunkerBossChange : CardAnimation
{
  ...
  private Vector3 RandomOffset() => new Vector3(PettyRandom.Range(-1f, 1f), PettyRandom.Range(-1f, 1f), 0.0f).normalized * PettyRandom.Range(0.0f, this.explosionPositionRandom);
