...
public class VfxStatusSystem : GameSystem
{
  ...
  private void CreateEffect(GameObject prefab, Vector3 position, Vector3 scale) => UnityEngine.Object.Instantiate<GameObject>(prefab, position, Quaternion.identity, this.transform).transform.localScale = scale;
