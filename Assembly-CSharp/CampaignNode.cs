...
public class CampaignNode : ISaveable<CampaignNodeSaveData>
{
  ...
  public CampaignNodeType type { get; private set; }
  ...
  private object CloneDataValue(KeyValuePair<string, object> pair) => !(pair.Value is ICloneable cloneable) ? pair.Value : cloneable.Clone();
