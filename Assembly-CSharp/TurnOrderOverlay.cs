...
public class TurnOrderOverlay : MonoBehaviour
{
  ...
  private void OnEnable() => global::Events.OnBattlePhaseStart += new UnityAction<Battle.Phase>(this.BattlePhaseStart);

  private void OnDisable() => global::Events.OnBattlePhaseStart -= new UnityAction<Battle.Phase>(this.BattlePhaseStart);
