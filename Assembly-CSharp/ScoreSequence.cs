...
public class ScoreSequence : MonoBehaviour
{
  ...
  private static string Format(string positive, string negative, int value) => value < 0 ? string.Format(negative, (object) value) : string.Format(positive, (object) value);
}
