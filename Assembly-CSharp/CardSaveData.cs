...
public class CardSaveData : ILoadable<CardData>
{
  ...
  public CardSaveData(CardData cardData)
  {
    ...
    if (!((UnityEngine.Object) cardData.cardType != (UnityEngine.Object) cardData.original.cardType))
      return;
  ...
  public CardData Load(bool keepId)
  {
    ...
    if (!(bool) (UnityEngine.Object) cardData1 && this.name.Contains("."))
      return (CardData) (DataFileBuilder<CardData, CardDataBuilder>) CardDataBuilder.MissingCardBuilder.Clone().FreeModify((Action<CardData>) (a => a.name = this.name)).WithTitle("Card missing " + this.name);
    if (!(bool) (UnityEngine.Object) cardData1)
      return (CardData) null;
    CardData cardData2 = !keepId || this.id < 0UL ? cardData1.Clone(this.random3, false) : cardData1.Clone(this.random3, this.id, false);
    ...
    if (upgrades != null && upgrades.Length > 0)
    {
      ...
      if (cardData2.upgrades.Any<CardUpgradeData>((Func<CardUpgradeData, bool>) (a => a.becomesTargetedCard)))
      {
        ...
        if (cardData1.playType == Card.PlayType.None)
          cardData1.playType = Card.PlayType.Play;
