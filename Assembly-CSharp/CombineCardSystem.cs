...
public class CombineCardSystem : GameSystem
{
  ...
  private void OnEnable() => global::Events.OnEntityEnterBackpack += new UnityAction<Entity>(this.EntityEnterBackpack);

  private void OnDisable() => global::Events.OnEntityEnterBackpack -= new UnityAction<Entity>(this.EntityEnterBackpack);
