...
public class FloatingTextManager : MonoBehaviourSingleton<FloatingTextManager>
{
  ...
  [SerializeField]
  private FloatingTextManager.Animation[] animations;
  [SerializeField]
  private FloatingTextManager.FadeCurve[] fadeCurves;
  private Dictionary<string, FloatingTextManager.Animation> animationDictionary;
  private Dictionary<string, FloatingTextManager.FadeCurve> fadeCurveDictionary;
  ...
  private FloatingText CreatePrefab()
  {
