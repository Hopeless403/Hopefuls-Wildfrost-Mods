...
public class CardTooltip : Tooltip
{
  ...
  private void CreateIcon(string type, string iconGroupName, int value) => CardManager.NewStatusIcon(type, this.iconGroups[iconGroupName]).SetValue(new Stat(value), false);
}
