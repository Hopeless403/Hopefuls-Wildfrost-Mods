...
public class Hit
{
  ...
  private int CalculateAttackEffectAmount(int statusEffectStacks) => !this.attacker.silenced ? Mathf.Max(0, Mathf.RoundToInt((float) (statusEffectStacks + this.attacker.effectBonus) * this.attacker.effectFactor)) : 0;
