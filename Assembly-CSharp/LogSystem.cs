...
public class LogSystem : GameSystem
{
  ...
  private void OnDisable() => Application.logMessageReceived -= new Application.LogCallback(LogSystem.Log);
  ...
  private static void Log(string log) => LogSystem.toLog += string.Format("[{0}] {1}\n", (object) DateTime.Now, (object) log);
