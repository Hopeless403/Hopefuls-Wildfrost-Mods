...
public class InspectSystem : GameSystem
{
  ...
  [SerializeField]
  private string openInput = "Inspect";
  [SerializeField]
  ...
  [SerializeField]
  private string inspectCharmsInput = "Options";
  [SerializeField]
  private float cardScale = 1f;
  [SerializeField]
  private Vector2 cardRandomAngle = new Vector2(0.0f, 2f);
  [SerializeField]
  private List<Entity> hover = new List<Entity>();
  [SerializeField]
  private bool idleAnimation = true;
  [SerializeField]
  private float idleAnimationFactor = 1f;
  [SerializeField]
  private float canInspectDelay = 0.1f;
  [SerializeField]
  private float canEndDelay = 0.1f;
  [SerializeField]
  private KeywordData injuredKeyword;
  private float wait;
  [Header("Inspect Charms")]
  [SerializeField]
  private GameObject inspectCharmsLayout;
  [SerializeField]
  private InspectCharmsSystem inspectCharmsSystem;
  ...
  [SerializeField]
  private RectTransform notePopGroup;
  [SerializeField]
  ...
  [Header("Fading")]
  [SerializeField]
  private CanvasGroup backgroundFade;
  [SerializeField]
  private CanvasGroup cardInfoFade;
  [SerializeField]
  private float fadeInDur = 0.2f;
  [SerializeField]
  ...
  private Entity drag;
  private Entity press;
  private Transform previousParent;
  private int previousChildIndex;
  private const float enableAnimationDelay = 0.1f;
  private float enableAnimationTimer;
  private float currentIdleAnimationFactor;
  private bool hasAnyCharms;
  ...
  private static ClassData GetClass(CardData cardData)
  {
  ...
  private void DisableIdleAnimation()
  {
    if (!(this.inspect?.display is Card display))
      return;
    if ((bool) (UnityEngine.Object) display.imageIdleAnimator)
  ...
  private void EntityUnHover(Entity entity) => this.hover.Remove(entity);

  private void EntityDrag(Entity entity) => this.drag = entity;
