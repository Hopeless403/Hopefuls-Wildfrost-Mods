...
{
  [SerializeField]
  private TribeFlagDisplay tribeFlagPrefab;
  [SerializeField]
  private Transform tribeFlagGroup;
  [SerializeField]
  private SelectLeader leaderSelection;
  [SerializeField]
  private Transform selectedFlagAnchor;
  [SerializeField]
  private TitleSetter titleSetter;
  [SerializeField]
  private ParticleSystem selectParticleSystem;
  private readonly List<TribeFlagDisplay> flags = new List<TribeFlagDisplay>();
  private readonly List<ClassData> tribes = new List<ClassData>();
  ...
  private IEnumerator SelectRoutine(TribeFlagDisplay flag, ClassData classData)
  {
