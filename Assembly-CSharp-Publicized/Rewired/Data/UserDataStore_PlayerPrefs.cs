...
namespace Rewired.Data
{
  public class UserDataStore_PlayerPrefs : UserDataStore
  {
    ...
    public string playerPrefsKey_controllerAssignments => string.Format("{0}_{1}", (object) this.playerPrefsKeyPrefix, (object) "ControllerAssignments");

    public bool loadControllerAssignments => this.loadKeyboardAssignments || this.loadMouseAssignments || this.loadJoystickAssignments;
    ...
    public int LoadPlayerDataNow(int playerId) => this.LoadPlayerDataNow(ReInput.players.GetPlayer(playerId));
    ...
    public int LoadJoystickCalibrationData(Joystick joystick) => joystick == null || !joystick.ImportCalibrationMapFromXmlString(this.GetJoystickCalibrationMapXml(joystick)) ? 0 : 1;

    public int LoadJoystickCalibrationData(int joystickId) => this.LoadJoystickCalibrationData(ReInput.controllers.GetJoystick(joystickId));
    ...
    public void SaveJoystickCalibrationData(int joystickId) => this.SaveJoystickCalibrationData(ReInput.controllers.GetJoystick(joystickId));
    ...
    public bool ControllerAssignmentSaveDataExists() => PlayerPrefs.HasKey(this.playerPrefsKey_controllerAssignments) && !string.IsNullOrEmpty(PlayerPrefs.GetString(this.playerPrefsKey_controllerAssignments));

    public string GetBasePlayerPrefsKey(Player player) => this.playerPrefsKeyPrefix + "|playerName=" + player.name;
    ...
    public string GetJoystickCalibrationMapPlayerPrefsKey(Joystick joystick) => this.playerPrefsKeyPrefix + "|dataType=CalibrationMap" + "|controllerType=" + joystick.type.ToString() + "|hardwareIdentifier=" + joystick.hardwareIdentifier + "|hardwareGuid=" + joystick.hardwareTypeGuid.ToString();

    public string GetInputBehaviorPlayerPrefsKey(Player player, int inputBehaviorId) => this.GetBasePlayerPrefsKey(player) + "|dataType=InputBehavior" + "|id=" + inputBehaviorId.ToString();
    ...
    public void RefreshLayoutManager(int playerId) => ReInput.players.GetPlayer(playerId)?.controllers.maps.layoutManager.Apply();
