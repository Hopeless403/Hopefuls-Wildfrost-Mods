...
namespace Rewired.Integration.UnityUI
{
  public abstract class RewiredPointerInputModule : BaseInputModule
  {
    ...
    public const int customButtonsStartingId = -2147483520;
    public const int customButtonsMaxCount = 128;
    public const int customButtonsLastId = -2147483392;
    public readonly List<IMouseInputSource> m_MouseInputSourcesList = new List<IMouseInputSource>();
    ...
    public readonly RewiredPointerInputModule.MouseState m_MouseState = new RewiredPointerInputModule.MouseState();

    public RewiredPointerInputModule.UnityInputSource defaultInputSource => this.__m_DefaultInputSource == null ? (this.__m_DefaultInputSource = new RewiredPointerInputModule.UnityInputSource()) : this.__m_DefaultInputSource;
