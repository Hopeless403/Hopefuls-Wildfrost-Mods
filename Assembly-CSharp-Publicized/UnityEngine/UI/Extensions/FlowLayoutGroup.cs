...
namespace UnityEngine.UI.Extensions
{
  ...
  public class FlowLayoutGroup : LayoutGroup
  {
    ...
    [SerializeField]
    public FlowLayoutGroup.Axis m_StartAxis;
    public readonly IList<RectTransform> _itemList = (IList<RectTransform>) new List<RectTransform>();
    ...
    public bool IsCenterAlign => this.childAlignment == TextAnchor.LowerCenter || this.childAlignment == TextAnchor.MiddleCenter || this.childAlignment == TextAnchor.UpperCenter;

    public bool IsRightAlign => this.childAlignment == TextAnchor.LowerRight || this.childAlignment == TextAnchor.MiddleRight || this.childAlignment == TextAnchor.UpperRight;

    public bool IsMiddleAlign => this.childAlignment == TextAnchor.MiddleLeft || this.childAlignment == TextAnchor.MiddleRight || this.childAlignment == TextAnchor.MiddleCenter;

    public bool IsLowerAlign => this.childAlignment == TextAnchor.LowerLeft || this.childAlignment == TextAnchor.LowerRight || this.childAlignment == TextAnchor.LowerCenter;
    ...
    public float CalculateColHorizontalOffset(
      float groupWidth,
      float xOffset,
