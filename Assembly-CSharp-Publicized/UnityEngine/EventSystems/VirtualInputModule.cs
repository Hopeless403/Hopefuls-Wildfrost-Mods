...
namespace UnityEngine.EventSystems
{
  ...
  public class VirtualInputModule : PointerInputModule
  {
    ...
    public PointerEventData.FramePressState oldButtonState = PointerEventData.FramePressState.NotChanged;
    public readonly PointerInputModule.MouseState m_MouseState = new PointerInputModule.MouseState();

    [Obsolete("Mode is no longer needed on input module as it handles both mouse and keyboard simultaneously.", false)]
    public VirtualInputModule.InputMode inputMode => VirtualInputModule.InputMode.Mouse;

    public Camera m_canvasCamera => this._cam ?? (this._cam = Camera.main);
    ...
    public bool SendSubmitEventToSelectedObject() => !((UnityEngine.Object) this.eventSystem.currentSelectedGameObject == (UnityEngine.Object) null) && this.GetBaseEventData().used;
    ...
    public override PointerInputModule.MouseState GetMousePointerEventData(int id)
    {
