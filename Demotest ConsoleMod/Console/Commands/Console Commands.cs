    ...
    public class ExportCards
    {
        ...
        private IEnumerator Start()
        {
            ...
            foreach (CardData cardData1 in AddressableLoader.GetGroup<CardData>("CardData"))
            {
                ...
                {
                    Card card = null;
                    yield return CardManager.CreateCard(cardData, (CardController)null, (Character)null, false, c => { card = c; });
    ...
    public partial class ConsoleCustom
    {
        ...
        public class CommandExportCards : Console.Command
        {
            ...
            public override IEnumerator Routine(string args)
            {
                ...
                if (cardData != null && !(cardData.mainSprite?.name == "Nothing"))
                {
                    ...
                    Screenshot(exportCards, Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), exportCards.folder, cardData.cardType.name), card.titleText.text + " (" + card.name + ").png", cardData.cardType.name == "Boss");
                    yield return null;
                    card = null;
                    cardData = null;
        ...
        public class CommandTrigger : Console.Command
        {
            ...
            public override IEnumerator Routine(string args)
            {
                ...
                {
                    yield return StatusEffectSystem.Apply(Console.hover, null, AddressableLoader.Get<StatusEffectData>("StatusEffectData", "Trigger"), 1);
                }
            }
        }
        public class CommandTriggerAll : Console.Command
        {
            ...
            public override IEnumerator Routine(string args)
            {
                ...
                {
                    var trigger = AddressableLoader.Get<StatusEffectData>("StatusEffectData", "Trigger");
