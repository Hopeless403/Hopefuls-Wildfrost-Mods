...
public abstract class StatusEffectApplyX : StatusEffectData
{
  ...
  public bool AppliesTo(StatusEffectApplyX.ApplyToFlags applyTo)
  {
...
label_18:
  ...
  [CompilerGenerated]
  public bool \u003CGetTargets\u003Eb__31_0(Entity card)
  {
    return (UnityEngine.Object) card != (UnityEngine.Object) this.target && this.CheckConstraints(card);
  }

  [CompilerGenerated]
  public CardContainer \u003CGetTargets\u003Eb__31_1(int i)
  {
    return References.Battle.GetRow(this.target.owner, i);
  }

  [CompilerGenerated]
  public CardContainer \u003CGetTargets\u003Eb__31_2(int i)
  {
    return References.Battle.GetRow(this.target.owner, i);
  }
