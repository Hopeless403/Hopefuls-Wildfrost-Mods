...
public class ChallengeListDisplayBuilder : MonoBehaviour
{
    ...
    out List<ChallengeProgress> challengeProgress)
  {
    ...
    inProgressChallenges = flag1 ? objectOfType1.activeChallenges.Where<ChallengeData>((Func<ChallengeData, bool>) (a => !a.hidden)).ToList<ChallengeData>() : new List<ChallengeData>();
