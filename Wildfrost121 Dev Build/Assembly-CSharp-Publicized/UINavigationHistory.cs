...
public static class UINavigationHistory
{
  ...
  {
    return !UINavigationHistory.items.Contains(item) ? 0 : UINavigationHistory.items.IndexOf(item);
  }

  public static void AddLayer(UINavigationLayer navLayer)
  {
    UINavigationHistory.layers.Add(new UINavigationHistory.Layer(navLayer));
  }
