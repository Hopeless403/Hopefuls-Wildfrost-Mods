...
public class CardScriptRemoveTrait : CardScript
{
  ...
  [CompilerGenerated]
  public bool \u003CRun\u003Eb__3_0(CardData.TraitStacks a)
  {
    return this.excluding.Contains<TraitData>(a.data);
  }

  [CompilerGenerated]
  public bool \u003CRun\u003Eb__3_1(CardData.TraitStacks a)
  {
    return this.toRemove.Contains<TraitData>(a.data);
  }
}
