...
namespace Deadpan.Enums.Engine.Components.Modding
{
  public static class Extensions
  {
    ...
    {
      return MetaprogressionSystem.Get<List<string>>("pets").Contains(inst.name);
    }

    public static void AddToPets(this CardData inst)
    {
      MetaprogressionSystem.Add<string>("pets", inst.name);
    }

    public static bool RemoveFromPets(this CardData inst)
    {
      return MetaprogressionSystem.Remove<string>("pets", inst.name);
    }
