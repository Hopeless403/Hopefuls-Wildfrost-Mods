...
public class LeaderProfileData : ScriptableObject
{
  ...
  public class Collection
  {
    ...
    [CompilerGenerated]
    public bool \u003CAddTo\u003Eb__4_0(CharacterType.PrefabGroup a)
    {
      return a.name == this.collectionName;
    }

    [CompilerGenerated]
    public bool \u003CAddTo\u003Eb__4_1(CharacterType.SpriteGroup a)
    {
      return a.name == this.collectionName;
    }

    [CompilerGenerated]
    public bool \u003CAddTo\u003Eb__4_2(CharacterType.ColorSetGroup a)
    {
      return a.name == this.collectionName;
    }
