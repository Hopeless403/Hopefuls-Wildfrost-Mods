...
namespace Rewired
{
  public sealed class HOTASTemplate : ControllerTemplate, IHOTASTemplate, IControllerTemplate
  {
    ...
    {
      get => this.GetElement<IControllerTemplateButton>(63);
    }

    IControllerTemplateButton IHOTASTemplate.throttleBaseButton5
    {
      get => this.GetElement<IControllerTemplateButton>(64);
    }
    ...
    {
      get => this.GetElement<IControllerTemplateAxis>(144);
    }
    ...
    {
      get => this.GetElement<IControllerTemplateAxis>(168);
    }
