    ...
    public partial class ConsoleMod
    {
        ...
        public class PatchScrollThroughPredicted
        {
            ...
            static bool CheckScrollPrevious(Console __instance)
            {
                ...
                if (__instance.input.text.IsNullOrWhitespace() || PatchRunMultipleCommands.exactCommand == null || !__instance.argsDisplay.gameObject.activeSelf || args?.Length <= 1 || !instance.scrollConfig)
                {
                    return true;
                }
                // String is non-empty.
