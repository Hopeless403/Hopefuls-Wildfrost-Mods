        ...
        public partial class Patches
        {
                ...
                switch (action.GetType().Name)
                {
                    ...
                    case nameof(ActionEffectApply):
                        ...
                        return $"""
                            ...
                            |   {actionEffectApply.sequences.ToArray().Join(delimiter: "\n|   ")}
                            """;
                    ...
                    case nameof(ActionProcessTrigger):
                        ...
                        var trigger = actionProcessTrigger.trigger;
                        if (trigger == null)
                            return "";
                        return $"""
                            |   {trigger.entity?.name}
            ...
            static string NotePerType(PlayAction action)
            {
                switch (action.GetType().Name)
                {
                    ...
                    case nameof(ActionEffectApply):
                        return $"{((ActionEffectApply)action).effect} → {((ActionEffectApply)action).sequences.ToArray().Join()}";
                    case nameof(ActionChangePhase):
