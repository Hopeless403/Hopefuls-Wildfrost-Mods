...
public class InputSystem : GameSystem
{
  ...
  {
    return !(InputSystem.Enabled & positive) ? InputSystem.mainPlayer.GetNegativeButtonDown(input) : InputSystem.mainPlayer.GetButtonDown(input);
  }

  public static bool IsButtonHeld(string input, bool positive = true)
  {
    return !(InputSystem.Enabled & positive) ? InputSystem.mainPlayer.GetNegativeButton(input) : InputSystem.mainPlayer.GetButton(input);
  }

  public static bool IsButtonLongHeld(string input, bool positive = true)
  {
    return !(InputSystem.Enabled & positive) ? InputSystem.mainPlayer.GetNegativeButtonLongPress(input) : InputSystem.mainPlayer.GetButtonLongPress(input);
  }

  public static bool IsButtonReleased(string input, bool positive = true)
  {
    return !(InputSystem.Enabled & positive) ? InputSystem.mainPlayer.GetNegativeButtonUp(input) : InputSystem.mainPlayer.GetButtonUp(input);
  }

  public static bool WasButtonPressed(string input, bool positive = true)
  {
    return !(InputSystem.Enabled & positive) ? InputSystem.mainPlayer.GetNegativeButtonPrev(input) : InputSystem.mainPlayer.GetButtonPrev(input);
  }
  ...
  {
    return InputSystem.Enabled ? InputSystem.mainPlayer.GetAxis(actionName) : 0.0f;
  }

  public static float GetAxisDelta(string actionName)
  {
    return InputSystem.Enabled ? InputSystem.mainPlayer.GetAxisDelta(actionName) : 0.0f;
  }
}
