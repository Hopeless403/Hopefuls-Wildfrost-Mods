...
public class BattleSaveData
{
  ...
  public class ContainerGroup
  {
    ...
    {
      this.containers = containers.Select<CardContainer, BattleSaveData.Container>((Func<CardContainer, BattleSaveData.Container>) (a => new BattleSaveData.Container(a))).ToArray<BattleSaveData.Container>();
    }
  }
