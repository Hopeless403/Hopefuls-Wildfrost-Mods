...
public class BattleWaveManager : MonoBehaviour
{
  ...
  public class Wave
  {
    ...
    {
      return string.Format("Wave ({0}) counter: {1}", (object) string.Join<CardData>(", ", (IEnumerable<CardData>) this.units), (object) this.counter);
    }
  }
  ...
  public class WaveDataBasic : BattleWaveManager.WaveData
  {
    ...
    {
      return AddressableLoader.Get<CardData>("CardData", this.cards[index].cardName);
    }
  ...
  public class WaveDataFull : BattleWaveManager.WaveData
  {
    ...
    public override CardData PeekCardData(int index)
    {
      return AddressableLoader.Get<CardData>("CardData", this.cardDatas[index].name);
    }
