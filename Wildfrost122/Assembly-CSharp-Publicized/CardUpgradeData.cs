...
public class CardUpgradeData : DataFile, ISaveable<CardUpgradeSaveData>
{
  ...
  [CompilerGenerated]
  public bool \u003CCheckSlots\u003Eb__47_0(CardUpgradeData a) => a.type == this.type && a.takeSlot;

  [CompilerGenerated]
  public bool \u003CCheckSlots\u003Eb__47_1(CardUpgradeData a) => a.type == this.type && a.takeSlot;

  [CompilerGenerated]
  public bool \u003CCheckSlots\u003Eb__47_2(CardUpgradeData a) => a.type == this.type && a.takeSlot;
