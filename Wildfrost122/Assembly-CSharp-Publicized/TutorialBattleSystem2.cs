...
public class TutorialBattleSystem2 : TutorialBattleSystem
{
  ...
  public class PhaseInspectEnemy : TutorialParentSystem.Phase
  {
    ...
    {
      return action is ActionInspect actionInspect && (UnityEngine.Object) actionInspect.entity == (UnityEngine.Object) this.target;
    }

    [CompilerGenerated]
    public string \u003COnEnable\u003Eb__3_0()
    {
      return string.Format(MonoBehaviourSingleton<Cursor3d>.instance.usingMouse ? ControllerButtonSystem.ProcessActionTags(MonoBehaviourSingleton<StringReference>.instance.tutorialBattle2_1) : ControllerButtonSystem.ProcessActionTags(MonoBehaviourSingleton<StringReference>.instance.tutorialBattle2_1Gamepad), (object) this.target.data.title);
    }
  }
  ...
  public class PhasePlaceCompanion : TutorialParentSystem.Phase
  {
    ...
    public bool CorrectAction(PlayAction action)
    {
      return action is ActionMove actionMove && actionMove.entity.data.name == this.target.data.name && actionMove.toContainers.Length == 1 && Battle.IsOnBoard(actionMove.toContainers[0].Group) && actionMove.toContainers[0].Group.Count == 0;
    }

    [CompilerGenerated]
    public string \u003CPromptAfter\u003Eb__4_0()
    {
      return string.Format(MonoBehaviourSingleton<StringReference>.instance.tutorialBattle2_2.GetLocalizedString(), (object) this.target.data.title);
    }
  }
  ...
  public class PhaseWaitDisallowRecall : TutorialParentSystem.Phase
  {
    ...
    {
      return action is ActionMove actionMove && actionMove.toContainers.Length == 1 && (UnityEngine.Object) actionMove.toContainers[0] == (UnityEngine.Object) References.Player.discardContainer;
    }
  ...
  public class PhaseMoveCompanionInFrontOfLeader : TutorialParentSystem.Phase
  {
    ...
    public bool CorrectAction(PlayAction action)
    {
      return action is ActionMove actionMove && actionMove.entity.data.name == this.target.data.name && actionMove.toContainers.Length == 1 && actionMove.toContainers[0] is CardSlot toContainer && (UnityEngine.Object) toContainer == (UnityEngine.Object) this.targetSlot;
    }

    [CompilerGenerated]
    public string \u003COnEnable\u003Eb__5_0()
    {
      return string.Format(MonoBehaviourSingleton<StringReference>.instance.tutorialBattle2_3.GetLocalizedString(), (object) this.target.data.title);
    }
  }
  ...
  public class PhaseBarrage : TutorialParentSystem.Phase
  {
    ...
    [CompilerGenerated]
    public string \u003COnEnable\u003Eb__5_2()
    {
      return string.Format(MonoBehaviourSingleton<StringReference>.instance.tutorialBattle2_41a.GetLocalizedString(), (object) this.barrageEnemy.data.title, (object) this.chosenUnit.data.title);
    }

    [CompilerGenerated]
    public string \u003COnEnable\u003Eb__5_3()
    {
      return string.Format(MonoBehaviourSingleton<StringReference>.instance.tutorialBattle2_41b.GetLocalizedString(), (object) this.barrageEnemy.data.title, (object) this.chosenUnit.data.title);
    }
  }
  ...
  public class PhaseRecallToHeal : TutorialParentSystem.Phase
  {
    ...
    public bool CorrectAction(PlayAction action)
    {
      return action is ActionMove actionMove && actionMove.entity.data.name == this.target.data.name && actionMove.toContainers.Length == 1 && (UnityEngine.Object) actionMove.toContainers[0] == (UnityEngine.Object) References.Player.discardContainer;
    }
    ...
    public string \u003COnEnable\u003Eb__3_0()
    {
      return string.Format(MonoBehaviourSingleton<StringReference>.instance.tutorialBattle2_5.GetLocalizedString(), (object) this.target.data.title);
    }
  }
