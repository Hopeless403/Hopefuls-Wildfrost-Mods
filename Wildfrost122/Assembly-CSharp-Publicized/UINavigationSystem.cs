...
public class UINavigationSystem : MonoBehaviourSingleton<UINavigationSystem>
{
  ...
  [CompilerGenerated]
  public bool \u003CGetSelectable\u003Eb__36_0(UINavigationItem x)
  {
    return (bool) (UnityEngine.Object) x && (UnityEngine.Object) x != (UnityEngine.Object) this.currentNavigationItem && x.CheckLayer();
  }
}
