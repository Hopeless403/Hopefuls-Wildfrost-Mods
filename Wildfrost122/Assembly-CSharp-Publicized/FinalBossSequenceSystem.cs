...
public class FinalBossSequenceSystem : GameSystem
{
  ...
  {
    return References.PlayerData.inventory.deck.FirstOrDefault<CardData>((Func<CardData, bool>) (a => a.name == this.sealCard));
  }
  ...
  [CompilerGenerated]
  public void \u003CPossessLeader\u003Eb__39_0(float a)
  {
