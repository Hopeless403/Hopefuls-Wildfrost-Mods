...
namespace Rewired.Demos
{
  ...
  public class TouchControls1_ManipulateCube : MonoBehaviour
  {
    ...
    public void OnMoveReceivedX(InputActionEventData data)
    {
      this.OnMoveReceived(new Vector2(data.GetAxis(), 0.0f));
    }

    public void OnMoveReceivedY(InputActionEventData data)
    {
      this.OnMoveReceived(new Vector2(0.0f, data.GetAxis()));
    }

    public void OnRotationReceivedX(InputActionEventData data)
    {
      this.OnRotationReceived(new Vector2(data.GetAxis(), 0.0f));
    }

    public void OnRotationReceivedY(InputActionEventData data)
    {
      this.OnRotationReceived(new Vector2(0.0f, data.GetAxis()));
    }
    ...
    public void OnMoveReceived(Vector2 move)
    {
      this.transform.Translate((Vector3) move * Time.deltaTime * this.moveSpeed, Space.World);
    }
