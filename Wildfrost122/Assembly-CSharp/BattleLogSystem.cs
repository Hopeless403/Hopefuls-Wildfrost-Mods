...
public class BattleLogSystem : GameSystem
{
  ...
  private void LogBlock(Entity target, int damageBlocked)
  {
  ...
  private void LogHeal(Entity healer, Entity target)
  {
  ...
  private void LogRestore(Entity target, int amount)
  {
  ...
  private void Log(LocalizedString textKey, BattleLogType type, params object[] args)
  {
