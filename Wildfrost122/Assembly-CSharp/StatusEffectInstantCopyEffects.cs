...
{
  [SerializeField]
  private bool replaceAllEffects = true;
  [SerializeField]
  [HideIf("replaceAllEffects")]
  private int replaceEffectNumber;
  ...
  private IEnumerator RemoveAllEffects()
  {
    StatusEffectInstantCopyEffects instantCopyEffects = this;
  ...
  private IEnumerator RemoveEffect(int effectNumber)
  {
  ...
  private IEnumerator AddEffectCopies()
  {
    StatusEffectInstantCopyEffects instantCopyEffects = this;
    // ISSUE: reference to a compiler-generated method
