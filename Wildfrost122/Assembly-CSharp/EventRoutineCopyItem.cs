...
public class EventRoutineCopyItem : EventRoutine
{
  ...
  [SerializeField]
  private CardType[] canCopyCardTypes;
  [SerializeField]
  private LocalizedString promptKey;
  [SerializeField]
  private LocalizedString confirmPromptKey;
  [SerializeField]
  private TweenUI moveToSide;
  [SerializeField]
  private TweenUI moveToCentre;
  [SerializeField]
  private Transform toCopyAnchor;
  [SerializeField]
  ...
  private bool promptCopy;
  private Entity toCopy;
  private int toCopyOriginalIndex;
