...
public class VfxHitSystem : GameSystem
{
  ...
  private VfxHitSystem.Profile GetProfile(int power)
  {
    return this.profiles[Mathf.Clamp(Mathf.RoundToInt(this.profileCurve.Evaluate((float) power)), 0, this.profiles.Length - 1)];
  }
