...
{
  [SerializeField]
  private CampaignNodeTypeShop.Stock stock;
  [Header("Prices")]
  [SerializeField]
  [MinMaxSlider(0.0f, 2f)]
  private Vector2 priceFactorRange = new Vector2(0.8f, 1.2f);
  [SerializeField]
  private int discounts = 1;
  [SerializeField]
  private float discountFactor = 0.5f;
  [SerializeField]
  private int charmPrice = 50;
  [SerializeField]
  private int charmPriceAdd = 20;
  [SerializeField]
  private int crownPrice = 80;
  [SerializeField]
  private int crownPriceAdd = 30;
  [SerializeField]
