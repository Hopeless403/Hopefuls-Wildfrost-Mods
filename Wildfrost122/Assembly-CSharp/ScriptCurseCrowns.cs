...
{
  [SerializeField]
  private int curseBossCrowns = 1;
  [SerializeField]
  private int curseShopCrowns = 1;
  [SerializeField]
  private int[] legalBossTiers = new int[1]{ 2 };
  [SerializeField]
  private int[] legalShopTiers = new int[4]{ 2, 3, 4, 5 };
  [SerializeField]
  private CardUpgradeData[] cursedCrowns;
  ...
  private bool TryCurseBossCrown(CampaignNode node, List<CardUpgradeData> pool)
  {
  ...
  private bool TryCurseShopCrown(CampaignNode node, List<CardUpgradeData> pool)
  {
  ...
  private static bool TryPullFromPool(List<CardUpgradeData> pool, out CardUpgradeData upgradeData)
  {
    if (pool.Count > 0)
    {
