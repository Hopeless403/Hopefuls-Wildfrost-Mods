...
public class EventRoutineCurseItems : EventRoutine
{
  ...
  [SerializeField]
  private Transform curseCardContainer;
  [SerializeField]
  ...
  [SerializeField]
  private EventReference takeSfxEvent;
  private bool analyticsEventSent;
  private readonly List<Entity> cards = new List<Entity>();
  private readonly List<Entity> curses = new List<Entity>();
  ...
  private IEnumerator TakeCard(Entity entity)
  {
    EventRoutineCurseItems routineCurseItems = this;
