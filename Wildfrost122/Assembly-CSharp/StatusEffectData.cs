...
public abstract class StatusEffectData : DataFile
{
  ...
  internal ulong id;
  private StatusEffectData original;
  ...
  internal StatusEffectData Instantiate()
  {
  ...
  protected event StatusEffectData.EffectEventHandler OnBegin;

  protected event StatusEffectData.EffectEventHandler OnEnd;

  protected event StatusEffectData.EffectEntityEventHandler OnEnable;

  protected event StatusEffectData.EffectEntityEventHandler OnDisable;

  protected event StatusEffectData.EffectStackEventHandler OnStack;

  protected event StatusEffectData.EffectEntityEventHandler OnTurnStart;

  protected event StatusEffectData.EffectEntityEventHandler OnTurn;

  protected event StatusEffectData.EffectEntityEventHandler OnTurnEnd;

  protected event StatusEffectData.EffectHitEventHandler PreAttack;

  protected event StatusEffectData.EffectHitEventHandler OnHit;

  protected event StatusEffectData.EffectHitEventHandler PostHit;

  protected event StatusEffectData.EffectHitEventHandler PostAttack;

  protected event StatusEffectData.EffectApplyEventHandler OnApplyStatus;

  protected event StatusEffectData.EffectApplyEventHandler PostApplyStatus;

  protected event StatusEffectData.EffectEntityDeathEventHandler OnEntityDestroyed;

  protected event StatusEffectData.EffectEntityEventHandler OnCardMove;

  protected event StatusEffectData.EffectTriggerEventHandler PreTrigger;

  protected event StatusEffectData.EffectCardPlayEventHandler PreCardPlayed;

  protected event StatusEffectData.EffectCardPlayEventHandler OnCardPlayed;

  protected event StatusEffectData.EffectEventHandler OnEffectBonusChanged;

  protected event StatusEffectData.EffectActionPerformedHandler OnActionPerformed;

  protected event StatusEffectData.EffectEntityEventHandler OnBuild;
  ...
  private bool HasActiveTarget => (Object) this.target != (Object) null && this.target.enabled;
  ...
  protected IEnumerator CountDown(Entity entity, int amount)
  {
  ...
  protected CardContainer[] GetTargetContainers()
  {
  ...
  protected CardContainer[] GetTargetActualContainers()
  {
  ...
  protected delegate IEnumerator EffectEventHandler();

  protected delegate IEnumerator EffectStackEventHandler(int stacks);

  protected delegate IEnumerator EffectCharacterEventHandler(Character character);

  protected delegate IEnumerator EffectEntityEventHandler(Entity entity);

  protected delegate IEnumerator EffectEntityDeathEventHandler(Entity entity, DeathType deathType);

  protected delegate IEnumerator EffectCardPlayEventHandler(Entity entity, Entity[] targets);

  protected delegate IEnumerator EffectTriggerEventHandler(Trigger trigger);

  protected delegate IEnumerator EffectCardMoveEventHandler(
    Entity entity,
    CardContainer[] fromContainers);

  protected delegate IEnumerator EffectHitEventHandler(Hit hit);

  protected delegate IEnumerator EffectApplyEventHandler(StatusEffectApply apply);

  protected delegate IEnumerator EffectActionPerformedHandler(PlayAction action);
}
