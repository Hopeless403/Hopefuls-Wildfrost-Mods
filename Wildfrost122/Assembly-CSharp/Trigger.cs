...
public class Trigger
{
  ...
  protected virtual IEnumerator ProcessHits()
  {
  ...
  protected static IEnumerator ProcessHit(Hit hit)
  {
  ...
  private static int[] GetRowIndices(Entity entity)
  {
