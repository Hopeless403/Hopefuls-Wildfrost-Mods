...
public class StatusEffectInstantSummon : StatusEffectInstant
{
  ...
  private bool buildingToSummon;
  private Entity toSummon;
  ...
  private IEnumerator CreateCopy(Entity toCopy, UnityAction<Entity> onComplete)
  {
    StatusEffectInstantSummon effectInstantSummon = this;
  ...
  private IEnumerator CreateCopyAndTrySummon()
  {
    StatusEffectInstantSummon effectInstantSummon = this;
    // ISSUE: reference to a compiler-generated method
  ...
  private static bool CanSummonInFrontOf(
    Entity inFrontOf,
    out CardContainer container,
    out Dictionary<Entity, List<CardSlot>> shoveData)
  {
  ...
  private static CardContainer GetSlotToShove(Entity entity)
  {
  ...
  private static bool CanSummonInEnemyRow(
    Entity target,
    out CardContainer container,
    out Dictionary<Entity, List<CardSlot>> shoveData)
  {
