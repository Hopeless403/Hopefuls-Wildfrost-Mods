...
public class ChallengeSystem : GameSystem
{
  ...
  private void OnEnable()
  {
    ...
    foreach (ChallengeData challengeData in this.activeChallenges.Where<ChallengeData>((Func<ChallengeData, bool>) (a => a.listener.checkType == ChallengeListener.CheckType.CustomSystem)))
      challengeData.listener.AddCustomSystem(challengeData, this);
  ...
  {
    this.activeChallenges.Remove(challengeData);
    this.saveRequired.Add(challengeData);
    this.CheckSave();
  }
  ...
  {
    return AddressableLoader.GetGroup<ChallengeData>("ChallengeData").Where<ChallengeData>((Func<ChallengeData, bool>) (a => a.reward.IsActive));
  }
}
