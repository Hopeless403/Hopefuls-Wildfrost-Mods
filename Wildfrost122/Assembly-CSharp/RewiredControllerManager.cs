...
public class RewiredControllerManager : MonoBehaviour
{
  ...
  internal List<RewiredControllerManager.PlayerMap> GetActiveDevices()
  {
    return RewiredControllerManager.playerMaps;
  }

  internal IList<Player> GetPlayers() => ReInput.players.GetPlayers(false);
  ...
  internal void AssignControllerToPlayer(int i, int controllerIndex)
  {
