...
public class HackedTextEffect : MonoBehaviour
{
  ...
  private TMP_Text tmp => this._tmp ?? (this._tmp = this.GetComponent<TMP_Text>());
  ...
  private void StartRoutine(string text) => this.StartCoroutine(this.Routine(text));
  ...
  private IEnumerator LoopChars(string text)
  {
  ...
  private IEnumerator AddCharsRandom(string text)
  {
  ...
  private IEnumerator AppendChars(string text)
  {
  ...
  private IEnumerator AddChar(string text)
  {
  ...
  private IEnumerator ReplaceChar(string text)
  {
    int index = text.RandomIndex<char>();
  ...
  private IEnumerator ColourChar(string text)
  {
    int index = text.RandomIndex<char>();
    char ch = text[index];
