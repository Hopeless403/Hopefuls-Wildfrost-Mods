...
public class StatusEffectApplyXWhenDamageTaken : StatusEffectApplyX
{
  ...
  {
    return (Object) hit.target == (Object) this.target && this.target.enabled && this.target.alive && hit.Offensive && hit.damageType == this.targetDamageType && Battle.IsOnBoard(this.target);
  }
