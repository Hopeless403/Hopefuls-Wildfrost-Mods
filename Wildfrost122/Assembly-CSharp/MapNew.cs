...
public class MapNew : MonoBehaviour
{
  ...
  {
    return this.nodes.Find((Predicate<MapNode>) (a => a.campaignNode == campaignNode));
  }

  private List<MapPath> FindPaths(MapNode fromNode)
  {
    return this.paths.FindAll((Predicate<MapPath>) (a => (UnityEngine.Object) a.StartNode == (UnityEngine.Object) fromNode));
  }
