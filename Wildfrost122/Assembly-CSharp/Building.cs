...
public class Building : MonoBehaviour
{
  ...
  [SerializeField]
  private UnityEventGameObject onSelect;
  [SerializeField]
  private GameObject toBuild;
  [SerializeField]
  private GameObject underConstruction;
  [SerializeField]
  private GameObject fullyBuilt;
  [SerializeField]
  private Building.Icon[] icons;
  [SerializeField]
  private UnityEvent onDataUpdated;
  ...
  {
    UnityEngine.Object.FindObjectOfType<BuildingDisplay>(true)?.Create(prefab, this);
  }
