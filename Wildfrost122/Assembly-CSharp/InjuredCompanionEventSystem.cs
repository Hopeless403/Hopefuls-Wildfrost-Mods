...
public class InjuredCompanionEventSystem : GameSystem
{
  ...
  {
    Events.OnCampaignLoadPreset += new Events.UnityActionRef<string[]>(InjuredCompanionEventSystem.CampaignLoadPreset);
  }
  ...
  private static bool IsEligible(CardSaveData card, string[] illegal)
  {
