...
public class StatusEffectTriggerWhenStatusApplied : StatusEffectReaction
{
  ...
  {
    return this.target.enabled && Battle.IsOnBoard(this.target) && this.Check(apply) && this.CanTrigger();
  }
