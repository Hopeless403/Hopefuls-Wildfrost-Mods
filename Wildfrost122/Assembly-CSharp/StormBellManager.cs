...
public class StormBellManager : MonoBehaviour
{
  ...
  private void SetGlobalStormBellCountParam()
  {
    SfxSystem.SetGlobalParam("stormbell_count", this.points >= 10 ? (float) Mathf.Max(10, this.active.Count) : (float) this.active.Count);
  }
  ...
  {
    return StormBellManager.GetCurrentStormPoints(StormBellManager.GetActiveStormBells()) >= 10;
  }
