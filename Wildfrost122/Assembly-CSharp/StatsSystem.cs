...
public class StatsSystem : GameSystem
{
  ...
  private void CardInjured(CardData cardData)
  {
  ...
  private void ShopItemHaggled(ShopItem item) => this.Stats.Add("shopItemsHaggled", 1);
  ...
  private void WaveDeployerEarlyDeploy() => this.Stats.Add("enemyWaveBellHits", 1);
