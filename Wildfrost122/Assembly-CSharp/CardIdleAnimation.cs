...
{
  private CardAnimationProfile profile;
  private Entity _entity;
  public bool alwaysOn;
  public float strength = 1f;
  public float speedFactor = 1f;
  public float fadeInTime = 0.4f;
  private float fadeInStrength = 1f;
  private float speed;
  ...
  [SerializeField]
  private CardAnimationProfile setProfile;
  [SerializeField]
  private CardIdleAnimation.Action currentAction;
  ...
  private void SetProfile(CardAnimationProfile profile)
  {
  ...
  private void StartAction(CardIdleAnimation.Action action)
  {
