...
public class SfxSystem : GameSystem
{
  ...
  private static bool CheckCooldown(string eventName)
  {
  ...
  private static int GetHitPower(Hit hit)
  {
  ...
  private static void EntityHover(Entity entity)
  {
  ...
  private static void EntityPlace(Entity entity, CardContainer[] containers, bool freeMove)
  {
    SfxSystem.OneShot("event:/sfx/card/place");
  }

  private static void EntityFlipUp(Entity entity)
  {
    SfxSystem.OneShotCheckCooldown("event:/sfx/card/flip_single");
  }

  private static void EntityFlipDown(Entity entity)
  {
    SfxSystem.OneShotCheckCooldown("event:/sfx/card/flip_single");
  }
  ...
  private static void EntityEnterPocket(Entity entity, CardPocket pocket)
  {
  ...
  private static void GoldFlyToBag(int amount, Character owner, Vector3 position)
  {
    SfxSystem.OneShot("event:/sfx/inventory/bling_flying");
  }

  private static void CollectGold(int amount)
  {
  ...
  private static void MapNodeReveal(MapNode node)
  {
    SfxSystem.OneShot("event:/sfx/map/location_showup");
  }

  private static void MapNodeHover(MapNode node)
  {
  ...
  private static void BombardShoot(Entity entity)
  {
    SfxSystem.OneShot("event:/sfx/specific/boss_shooting");
  }

  private static void BombardRocketFall(BombardRocket rocket)
  {
    SfxSystem.OneShot("event:/sfx/specific/boss_rockets_flying");
  }

  private static void BombardRocketExplode(BombardRocket rocket)
  {
  ...
  private static void TownUnlockPopUp(UnlockData unlockData)
  {
  ...
  private static void AbilityTargetAdd(CardContainer container)
  {
