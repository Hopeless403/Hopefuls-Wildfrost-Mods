...
public class CardData : DataFile, ISaveable<CardSaveData>
{
  ...
  [SerializeField]
  private CardScript[] createScripts;
  public Dictionary<string, object> customData;

  public ulong id { get; private set; }

  private void SetId(ulong value)
  {
    this.id = value;
  ...
  private bool IsItem => this.playType == Card.PlayType.Play;

  private bool DoesShove
  {
    get
    {
  ...
  public CardData original { get; private set; }
